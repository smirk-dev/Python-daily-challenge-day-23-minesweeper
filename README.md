...
A modernized **Minesweeper** game built using **Python and Pygame**, featuring an intuitive UI, smooth animations, and a high-score tracking system.

## 🎮 Features

- 🎨 **Minimalistic UI** with smooth hover and click animations.  
- 🏆 **High Scores System** that saves the fastest game completions.  
- 💣 **Dynamic Grid Generation** with randomly placed mines.  
- 🚩 **Right-click to Flag** suspected mines.  
- ✅ **Win Detection** when all non-mine tiles are revealed.  
- 🔄 **Auto-Reveal Empty Cells** when clicking on a zero-tile.  
- 📜 **Easy-to-Navigate Menu** with Start, High Scores, and Quit options.  
...
3. Clone this repository:  
   ```sh
   git clone https://github.com/smirk-dev/minesweeper-game.git
   cd minesweeper-game
   ```
4. Run the game:  
   ```sh
...
- **Win the game** by uncovering all non-mine tiles.  

## 📜 High Scores

The game automatically saves your fastest completion times in `high_scores.json`, displaying the **Top 10** scores in the High Scores menu.

## 🔧 Future Enhancements

- ⏳ **Timer UI improvements**  
- 🎶 **Sound Effects** for interactions  
- 🌎 **Different Grid Sizes & Difficulty Levels**  
